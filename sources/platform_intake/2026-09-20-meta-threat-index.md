...
Next review: inspect the linked CIB PDF and indicator schema, record exact network-level counts and attribution methods, check campaign overlap, then obtain independent full-text and construct coding. No row in the final evidence map should be admitted from this intake alone.
