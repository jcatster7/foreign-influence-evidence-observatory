...
Next gate: hydrate and read the canonical manifest, check recovery hashes against it, run the access preflight in `LOW_COST_REPLICATION_PROTOCOL.md`, and obtain an independent second reviewer. Until those conditions hold, the low-cost protocol remains unexecuted and external spend remains $0.
